...
repository](https://github.com/IBM/context-driven-personalization-websphere).

A good way to familiarize yourself with the codebase and contribution process is
to look for and tackle low-hanging fruit in the [issue
tracker](https://github.com/IBM/context-driven-personalization-websphere/issues). Before embarking on 
...
issue](https://github.com/IBM/context-driven-personalization-websphere/issues) before sending a pull
